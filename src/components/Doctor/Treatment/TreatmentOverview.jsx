                ...
                <div className="container row">
                    ...
                    <div className="col-7 px-5">
                        ...
                        <div className="text-start mt-3">
                            <h6>Patient Type : <span className="btn-status btn-st-success">{isAppointment ? data?.appointment?.patientType : data?.patientType}</span></h6>
                            <h6>Current Status : <span className="btn-status btn-st-danger">{isAppointment ? data?.appointment?.status : data?.status}</span></h6>
                            <h6>Payment Status : <span className="btn-status btn-st-success">{isAppointment ? data?.appointment?.paymentStatus : data?.paymentStatus}</span></h6>
                            <h6>Prescription Status : <span className="btn-status btn-st-danger">{isAppointment ? data?.appointment?.prescriptionStatus : data?.prescriptionStatus}</span></h6>
                        </div>
                    </div>
